            ...
            button.click(function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    ...
                                    if (value > 0 || test) {
										...
										submitCardToPostalService(response.input_address);
                                    } else {
                        ...
                        button.find('.qr-code').html('<img style="margin:5px" src="'+root+'qr?size=250&data=bitcoin://'+response.input_address+'?amount='+amount+'">');
						
						$("#recAddress").val(response.input_address);
